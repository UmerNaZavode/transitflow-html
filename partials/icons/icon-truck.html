<svg width="62" height="62" viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path
    ...
    fill="#FFD550" stroke="#1C1F35" stroke-width="2" />
  ...
  <path
    ...
    stroke="#1C1F35" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
  <path d="M8.85742 28.0947L8.85742 18.8215" stroke="#1C1F35" stroke-width="2" stroke-linecap="round"
    stroke-linejoin="round" />
  <path d="M28.7854 31L38.0586 31" stroke="#1C1F35" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
  <path d="M28.786 49.7148L32.1074 49.7148" stroke="#1C1F35" stroke-width="2" stroke-linecap="round"
    stroke-linejoin="round" />
</svg>
